...
function test_query_timeout() {
	...
	export GO_FAILPOINTS="github.com/amyangfei/tiflow/dm/syncer/BlockSyncStatus=return(\"5s\")"
...
function test_stop_task_before_checkpoint() {
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/dm/loader/WaitLoaderStopAfterInitCheckpoint=return(5)'
	run_dm_worker $WORK_DIR/worker1 $WORKER1_PORT $cur/conf/dm-worker1.toml
	check_rpc_alive $cur/../bin/check_worker_online 127.0.0.1:$WORKER1_PORT
	run_dm_worker $WORK_DIR/worker2 $WORKER2_PORT $cur/conf/dm-worker2.toml
	check_rpc_alive $cur/../bin/check_worker_online 127.0.0.1:$WORKER2_PORT
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/dm/loader/WaitLoaderStopBeforeLoadCheckpoint=return(5)'
	run_dm_worker $WORK_DIR/worker1 $WORKER1_PORT $cur/conf/dm-worker1.toml
	run_dm_worker $WORK_DIR/worker2 $WORKER2_PORT $cur/conf/dm-worker2.toml
	check_rpc_alive $cur/../bin/check_worker_online 127.0.0.1:$WORKER1_PORT
	check_rpc_alive $cur/../bin/check_worker_online 127.0.0.1:$WORKER2_PORT
...
function test_fail_job_between_event() {
	...
	inject_points=(
		"github.com/amyangfei/tiflow/dm/dm/worker/TaskCheckInterval=return(\"500ms\")"
		"github.com/amyangfei/tiflow/dm/syncer/countJobFromOneEvent=return()"
		"github.com/amyangfei/tiflow/dm/syncer/flushFirstJob=return()"
		"github.com/amyangfei/tiflow/dm/syncer/failSecondJob=return()"
	)
	...
	inject_points=(
		"github.com/amyangfei/tiflow/dm/dm/worker/TaskCheckInterval=return(\"500ms\")"
		"github.com/amyangfei/tiflow/dm/syncer/countJobFromOneGTID=return()"
		"github.com/amyangfei/tiflow/dm/syncer/flushFirstJob=return()"
		"github.com/amyangfei/tiflow/dm/syncer/failSecondJob=return()"
	)
	export GO_FAILPOINTS="$(join_string \; ${inject_points[@]})"
...
function run() {
	...
	inject_points=(
		"github.com/amyangfei/tiflow/dm/dm/worker/TaskCheckInterval=return(\"500ms\")"
		"github.com/amyangfei/tiflow/dm/relay/NewUpstreamServer=return(true)"
	)
	export GO_FAILPOINTS="$(join_string \; ${inject_points[@]})"

...
function run() {
	...
	export GO_FAILPOINTS="github.com/amyangfei/tiflow/dm/syncer/FlushCheckpointStage=return(2)"
	...
	check_metric $WORKER2_PORT "dm_worker_task_state{source_id=\"mysql-replica-02\",task=\"test\",worker=\"worker2\"}" 3 1 3

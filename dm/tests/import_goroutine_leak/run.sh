...
function run() {
	...
	inject_points=("github.com/amyangfei/tiflow/dm/loader/LoadDataSlowDown=sleep(1000)"
		"github.com/amyangfei/tiflow/dm/loader/dispatchError=return(1)"
		"github.com/amyangfei/tiflow/dm/loader/executeSQLError=return(1)"
		"github.com/amyangfei/tiflow/dm/loader/returnDoJobError=return(1)"
		"github.com/amyangfei/tiflow/dm/loader/workerCantClose=return(1)"
	)
	...
	inject_points=("github.com/amyangfei/tiflow/dm/loader/LoadDataSlowDown=sleep(1000)"
		...
		"github.com/amyangfei/tiflow/dm/loader/executeSQLError=return(1)"
		"github.com/amyangfei/tiflow/dm/loader/returnDoJobError=return(1)"
		"github.com/amyangfei/tiflow/dm/loader/dontWaitWorkerExit=return(1)"
	)
	export GO_FAILPOINTS="$(join_string \; ${inject_points[@]})"
	run_dm_worker $WORK_DIR/worker1 $WORKER1_PORT $cur/conf/dm-worker1.toml
	...
	inject_points=("github.com/amyangfei/tiflow/dm/loader/LoadDataSlowDown=sleep(1000)"
		"github.com/amyangfei/tiflow/dm/loader/executeSQLError=return(1)"
		"github.com/amyangfei/tiflow/dm/loader/returnDoJobError=return(1)"
		"github.com/amyangfei/tiflow/dm/loader/workerChanSize=return(10)"
	)
	export GO_FAILPOINTS="$(join_string \; ${inject_points[@]})"
	run_dm_worker $WORK_DIR/worker1 $WORKER1_PORT $cur/conf/dm-worker1.toml
	check_rpc_alive $cur/../bin/check_worker_online 127.0.0.1:$WORKER1_PORT

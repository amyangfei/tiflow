...
function run() {
	...
	inject_points=(
		"github.com/amyangfei/tiflow/dm/syncer/online-ddl-tools/ExitAfterSaveOnlineDDL=return()"
		"github.com/amyangfei/tiflow/dm/syncer/ExitAfterSaveOnlineDDL=return()"
	)

...
function run() {
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/dm/syncer/ExitAfterDDLBeforeFlush=return(true)'
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/dm/relay/MockRecoverRelayWriter=return(true)'

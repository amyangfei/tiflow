...
function test_worker_restart() {
	...
	# worker1 online
	export GO_FAILPOINTS="github.com/amyangfei/tiflow/dm/loader/LightningLoadDataSlowDownByTask=return(\"load_task1\")"
...
function test_transfer_two_sources() {
	...
	# worker2 online
	export GO_FAILPOINTS="github.com/amyangfei/tiflow/dm/loader/LightningLoadDataSlowDown=sleep(15000)"
...
function run() {
	...
	export GO_FAILPOINTS="github.com/amyangfei/tiflow/dm/loader/LightningLoadDataSlowDownByTask=return(\"load_task2\")"
	run_dm_worker $WORK_DIR/worker2 $WORKER2_PORT $CONF_DIR/dm-worker2.toml
	check_rpc_alive $cur/../bin/check_worker_online 127.0.0.1:$WORKER2_PORT
	...
	export GO_FAILPOINTS="github.com/amyangfei/tiflow/dm/loader/LightningLoadDataSlowDownByTask=return(\"load_task3\")"
	run_dm_worker $WORK_DIR/worker3 $WORKER3_PORT $CONF_DIR/dm-worker3.toml
	check_rpc_alive $cur/../bin/check_worker_online 127.0.0.1:$WORKER3_PORT

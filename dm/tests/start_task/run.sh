...
function run() {
	...
	failpoints=(
		...
		"github.com/amyangfei/tiflow/dm/pkg/utils/FetchTargetDoTablesFailed=return(1152)"
		"github.com/amyangfei/tiflow/dm/pkg/utils/FetchAllDoTablesFailed=return(1152)"
	)

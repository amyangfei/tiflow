...
function test_cant_dail_upstream() {
	...
	export GO_FAILPOINTS="github.com/amyangfei/tiflow/dm/pkg/conn/failDBPing=return()"
	run_dm_worker $WORK_DIR/worker1 $WORKER1_PORT $cur/conf/dm-worker1.toml
	check_rpc_alive $cur/../bin/check_worker_online 127.0.0.1:$WORKER1_PORT
...
function run() {
	...
	export GO_FAILPOINTS="github.com/amyangfei/tiflow/dm/relay/ReportRelayLogSpaceInBackground=return(1)"

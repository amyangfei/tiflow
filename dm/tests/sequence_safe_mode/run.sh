...
function run() {
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/dm/syncer/SequenceShardSyncedExecutionExit=return(true);github.com/amyangfei/tiflow/dm/syncer/SafeModeInitPhaseSeconds=return(300)'

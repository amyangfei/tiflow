...
function test_kill_and_isolate_worker() {
	inject_points=("github.com/amyangfei/tiflow/dm/dm/worker/defaultKeepAliveTTL=return(1)"
		"github.com/amyangfei/tiflow/dm/dm/worker/defaultRelayKeepAliveTTL=return(2)"
	)

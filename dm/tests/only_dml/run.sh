...
function run() {
	export GO_FAILPOINTS="github.com/amyangfei/tiflow/dm/relay/SetHeartbeatInterval=return(1);github.com/amyangfei/tiflow/dm/syncer/syncDMLBatchNotFull=return(true)"

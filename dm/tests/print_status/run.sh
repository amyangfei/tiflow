...
function run() {
	...
	inject_points=("github.com/amyangfei/tiflow/dm/dm/worker/PrintStatusCheckSeconds=return(1)"
		"github.com/amyangfei/tiflow/dm/loader/LoadDataSlowDown=sleep(100)"
		"github.com/amyangfei/tiflow/dm/syncer/ProcessBinlogSlowDown=sleep(4)")

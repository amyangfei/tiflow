...
function fail_acquire_global_lock() {
	export GO_FAILPOINTS="github.com/amyangfei/tiflow/dm/dm/worker/TaskCheckInterval=return(\"500ms\")"
...
function escape_schema() {
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/dm/dumpling/SkipRemovingDumplingMetrics=return("")'

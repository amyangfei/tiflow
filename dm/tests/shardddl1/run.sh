...
function DM_RemoveLock() {
	...
	export GO_FAILPOINTS="github.com/amyangfei/tiflow/dm/dm/master/shardddl/SleepWhenRemoveLock=return(30)"
...
function DM_COMPACT() {
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/dm/syncer/BlockExecuteSQLs=return(1);github.com/amyangfei/tiflow/dm/syncer/SafeModeInitPhaseSeconds=return(5)'
...
function DM_COMPACT_USE_DOWNSTREAM_SCHEMA() {
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/dm/syncer/SkipFlushCompactor=return();github.com/amyangfei/tiflow/dm/syncer/DownstreamIdentifyKeyCheckInCompact=return(20)'
	run_dm_worker $WORK_DIR/worker1 $WORKER1_PORT $cur/conf/dm-worker1.toml
	run_dm_worker $WORK_DIR/worker2 $WORKER2_PORT $cur/conf/dm-worker2.toml
	check_rpc_alive $cur/../bin/check_worker_online 127.0.0.1:$WORKER1_PORT
	check_rpc_alive $cur/../bin/check_worker_online 127.0.0.1:$WORKER2_PORT

...
function run() {
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/dm/relay/SlowDownWriteDMLRelayLog=10*return();github.com/amyangfei/tiflow/dm/relay/SetHeartbeatInterval=return(5)'

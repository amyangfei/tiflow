...
- Fix the issue of a meta file writing failure when Relay Log is enabled and upstream database switches [#3164](https://github.com/amyangfei/tiflow/pull/3164)

### Improvements

- Reduce latency when Relay Log is enabled [#2225](https://github.com/pingcap/dm/pull/2225)
- Compress/merge DML statements for incremental replication to reduce replication latency [#3162](https://github.com/amyangfei/tiflow/pull/3162) [#3167](https://github.com/amyangfei/tiflow/pull/3167)
...
- Support for automatic acquisition and configuration of upstream and downstream time zones [#3403](https://github.com/amyangfei/tiflow/pull/3403)

### Known issues

[GitHub issues](https://github.com/amyangfei/tiflow/issues?q=is%3Aissue+is%3Aopen+label%3Atype%2Fbug+label%3Aarea%2Fdm)

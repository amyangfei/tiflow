...
func (t *testRelaySuite) TestTryRecoverLatestFile(c *C) {
	...
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/pkg/utils/GetGTIDPurged", `return("406a3f61-690d-11e7-87c5-6c92bf46f384:1-122")`), IsNil)
	//nolint:errcheck
	defer failpoint.Disable("github.com/amyangfei/tiflow/dm/pkg/utils/GetGTIDPurged")
...
func (t *testRelaySuite) TestTryRecoverMeta(c *C) {
	...
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/pkg/utils/GetGTIDPurged", `return("")`), IsNil)
	//nolint:errcheck
	defer failpoint.Disable("github.com/amyangfei/tiflow/dm/pkg/utils/GetGTIDPurged")
	c.Assert(r.tryRecoverLatestFile(context.Background(), parser2), IsNil)
	_, latestPos := r.meta.Pos()
...
func (t *testRelaySuite) TestReSetupMeta(c *C) {
	...
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/pkg/binlog/reader/MockGetEmptyPreviousGTIDFromGTIDSet", "return()"), IsNil)
	//nolint:errcheck
	defer failpoint.Disable("github.com/amyangfei/tiflow/dm/pkg/binlog/reader/MockGetEmptyPreviousGTIDFromGTIDSet")

...
func (t *testStreamerSuite) TestStreamer(c *C) {
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/relay/SetHeartbeatInterval", "return(10000)"), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("github.com/amyangfei/tiflow/dm/relay/SetHeartbeatInterval"), IsNil)
	}()
...
func (t *testStreamerSuite) TestHeartbeat(c *C) {
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/relay/SetHeartbeatInterval", "return(1)"), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("github.com/amyangfei/tiflow/dm/relay/SetHeartbeatInterval"), IsNil)
	}()

...
func (s *testSyncerSuite) TestCompactorSafeMode(c *C) {
	...
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/syncer/SkipFlushCompactor", `return()`), IsNil)
	//nolint:errcheck
	defer failpoint.Disable("github.com/amyangfei/tiflow/dm/syncer/SkipFlushCompactor")

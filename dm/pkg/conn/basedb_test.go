...
func (t *testBaseDBSuite) TestFailDBPing(c *C) {
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/pkg/conn/failDBPing", "return"), IsNil)
	//nolint:errcheck
	defer failpoint.Disable("github.com/amyangfei/tiflow/dm/pkg/conn/failDBPing")

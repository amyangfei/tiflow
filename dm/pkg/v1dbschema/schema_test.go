...
func (t *testSchema) TestSchemaV106ToV20x(c *C) {
	...
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/pkg/v1dbschema/MockGetGTIDsForPos", `return("ccb992ad-a557-11ea-ba6a-0242ac140002:10-16")`), IsNil)
	//nolint:errcheck
	defer failpoint.Disable("github.com/amyangfei/tiflow/dm/pkg/v1dbschema/MockGetGTIDsForPos")
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/pkg/utils/GetGTIDPurged", `return("ccb992ad-a557-11ea-ba6a-0242ac140002:1-9")`), IsNil)
	//nolint:errcheck

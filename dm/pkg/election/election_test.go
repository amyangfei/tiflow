...
func testElection2After1(t *testElectionSuite, c *C, normalExit bool) {
	...
	defer cancel1()
	if !normalExit {
		c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/pkg/election/mockCampaignLoopExitedAbnormally", `return()`), IsNil)
		//nolint:errcheck
		defer failpoint.Disable("github.com/amyangfei/tiflow/dm/pkg/election/mockCampaignLoopExitedAbnormally")
	}
	...
	if !normalExit {
		c.Assert(failpoint.Disable("github.com/amyangfei/tiflow/dm/pkg/election/mockCampaignLoopExitedAbnormally"), IsNil)
	}

...
func (t *testEtcdUtilSuite) testDoOpsInOneTxnWithRetry(c *C) {
	...
	// enable failpoint
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/pkg/etcdutil/ErrNoSpace", `3*return()`), IsNil)
	//nolint:errcheck
	defer failpoint.Disable("github.com/amyangfei/tiflow/dm/pkg/etcdutil/ErrNoSpace")

...
func (d *testDumplingSuite) TestDumpling(c *C) {
	...
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/dumpling/dumpUnitProcessNoError", `return(true)`), IsNil)
	//nolint:errcheck
	defer failpoint.Disable("github.com/amyangfei/tiflow/dm/dumpling/dumpUnitProcessNoError")
	...
	//nolint:errcheck
	failpoint.Disable("github.com/amyangfei/tiflow/dm/dumpling/dumpUnitProcessNoError")

	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/dumpling/dumpUnitProcessWithError", `return("unknown error")`), IsNil)
	// nolint:errcheck
	...
	// cancel
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/dumpling/dumpUnitProcessCancel", `return("unknown error")`), IsNil)
	// nolint:errcheck
	defer failpoint.Disable("github.com/amyangfei/tiflow/dm/dumpling/dumpUnitProcessCancel")
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/dumpling/dumpUnitProcessForever", `return(true)`), IsNil)
	//nolint:errcheck

...
func (t *testServer2) SetUpSuite(c *C) {
	...
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/dm/worker/MockGetSourceCfgFromETCD", `return(true)`), IsNil)
}

func (t *testServer2) TearDownSuite(c *C) {
	getMinLocForSubTaskFunc = getMinLocForSubTask
	c.Assert(failpoint.Disable("github.com/amyangfei/tiflow/dm/dm/worker/MockGetSourceCfgFromETCD"), IsNil)
}
...
func (t *testServer2) TestTaskAutoResume(c *C) {
	...
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/dumpling/dumpUnitProcessForever", `return()`), IsNil)
	//nolint:errcheck
	defer failpoint.Disable("github.com/amyangfei/tiflow/dm/dumpling/dumpUnitProcessForever")
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/dm/worker/mockCreateUnitsDumpOnly", `return(true)`), IsNil)
	//nolint:errcheck
	defer failpoint.Disable("github.com/amyangfei/tiflow/dm/dm/worker/mockCreateUnitsDumpOnly")
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/loader/ignoreLoadCheckpointErr", `return()`), IsNil)
	//nolint:errcheck
	defer failpoint.Disable("github.com/amyangfei/tiflow/dm/loader/ignoreLoadCheckpointErr")
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/dumpling/dumpUnitProcessWithError", `return("test auto resume inject error")`), IsNil)
	//nolint:errcheck
	defer failpoint.Disable("github.com/amyangfei/tiflow/dm/dumpling/dumpUnitProcessWithError")
	...
	//nolint:errcheck
	failpoint.Disable("github.com/amyangfei/tiflow/dm/dumpling/dumpUnitProcessWithError")

...
func (t *testElectionSuite) TestFailToStartLeader(c *check.C) {
	...
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/dm/master/FailToStartLeader", `return("dm-master-2")`), check.IsNil)
	//nolint:errcheck
	defer failpoint.Disable("github.com/amyangfei/tiflow/dm/dm/master/FailToStartLeader")
	...
	//nolint:errcheck
	failpoint.Disable("github.com/amyangfei/tiflow/dm/dm/master/FailToStartLeader")
	s1.election.Resign()
	time.Sleep(1 * time.Second)

...
func (t *testScheduler) TestTransferSource(c *C) {
	...
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/dm/master/scheduler/failToReplaceSourceBound", `return()`), IsNil)
	c.Assert(s.TransferSource(sourceID1, workerName1), NotNil)
	c.Assert(s.bounds[sourceID1], DeepEquals, worker4)
	c.Assert(worker1.Stage(), Equals, WorkerFree)
	c.Assert(failpoint.Disable("github.com/amyangfei/tiflow/dm/dm/master/scheduler/failToReplaceSourceBound"), IsNil)
...
func (t *testScheduler) TestCloseAllWorkers(c *C) {
	...
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/dm/dm/master/scheduler/failToRecoverWorkersBounds", "return"), IsNil)
	...
	c.Assert(failpoint.Disable("github.com/amyangfei/tiflow/dm/dm/master/scheduler/failToRecoverWorkersBounds"), IsNil)

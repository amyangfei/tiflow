...
import (
	...
	"github.com/amyangfei/tiflow/pkg/fsutil"
...
func (s *backendPoolSuite) TestBasicFunction(c *check.C) {
	...
	err = failpoint.Enable("github.com/amyangfei/tiflow/cdc/sorter/unified/memoryPressureInjectPoint", "return(100)")
	c.Assert(err, check.IsNil)
	...
	err = failpoint.Enable("github.com/amyangfei/tiflow/cdc/sorter/unified/memoryPressureInjectPoint", "return(0)")
	c.Assert(err, check.IsNil)
	err = failpoint.Enable("github.com/amyangfei/tiflow/cdc/sorter/unified/memoryUsageInjectPoint", "return(34359738368)")
	c.Assert(err, check.IsNil)
	...
	err = failpoint.Enable("github.com/amyangfei/tiflow/cdc/sorter/unified/memoryPressureInjectPoint", "return(0)")
	c.Assert(err, check.IsNil)
	err = failpoint.Enable("github.com/amyangfei/tiflow/cdc/sorter/unified/memoryUsageInjectPoint", "return(0)")
	c.Assert(err, check.IsNil)
...
func (s *backendPoolSuite) TestCleanUpSelf(c *check.C) {
	...
	err = failpoint.Enable("github.com/amyangfei/tiflow/cdc/sorter/unified/memoryPressureInjectPoint", "return(100)")
	c.Assert(err, check.IsNil)
	defer failpoint.Disable("github.com/amyangfei/tiflow/cdc/sorter/unified/memoryPressureInjectPoint") //nolint:errcheck
...
func (s *backendPoolSuite) TestCheckDataDirSatisfied(c *check.C) {
	...
	c.Assert(failpoint.Enable("github.com/amyangfei/tiflow/cdc/sorter/unified/InjectCheckDataDirSatisfied", ""), check.IsNil)
	err := checkDataDirSatisfied()
	c.Assert(err, check.IsNil)
	c.Assert(failpoint.Disable("github.com/amyangfei/tiflow/cdc/sorter/unified/InjectCheckDataDirSatisfied"), check.IsNil)
}

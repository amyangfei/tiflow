...
func (s *sorterSuite) TestMergerSortDelay(c *check.C) {
	...
	err = failpoint.Enable("github.com/amyangfei/tiflow/cdc/sorter/unified/sorterMergeDelay", "sleep(5)")
	c.Assert(err, check.IsNil)
	defer func() {
		_ = failpoint.Disable("github.com/amyangfei/tiflow/cdc/sorter/unified/sorterMergeDelay")
	}()
...
func (s *sorterSuite) TestMergerCancel(c *check.C) {
	...
	// enable the failpoint to simulate delays
	err = failpoint.Enable("github.com/amyangfei/tiflow/cdc/sorter/unified/sorterMergeDelay", "sleep(10)")
	c.Assert(err, check.IsNil)
	defer func() {
		_ = failpoint.Disable("github.com/amyangfei/tiflow/cdc/sorter/unified/sorterMergeDelay")
	}()
...
func (s *sorterSuite) TestMergerOutputBlocked(c *check.C) {
	...
	err := failpoint.Enable("github.com/amyangfei/tiflow/cdc/sorter/unified/sorterDebug", "return(true)")
	c.Assert(err, check.IsNil)
	defer failpoint.Disable("github.com/amyangfei/tiflow/cdc/sorter/unified/sorterDebug") //nolint:errcheck

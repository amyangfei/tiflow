...
The most common preparations for writing and submitting a design document for now is [creating a discuss issue](https://github.com/amyangfei/tiflow/issues/new/choose), which is going to be converted into a tracking issue of the design implementation.
...
4. If accepted, [create a tracking issue](https://github.com/amyangfei/tiflow/issues/new/choose) for the design document or convert one from a previous discuss issue. The tracking issue basically tracks subtasks and progress. And refer the tracking issue in the design document replacing placeholder in the template.

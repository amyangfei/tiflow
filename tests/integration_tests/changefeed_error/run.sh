...
function run() {
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/cdc/owner/NewChangefeedNoRetryError=1*return(true)'
	...
	*) SINK_URI="mysql://normal:123456@127.0.0.1:3306/?max-txn-row=1" ;;
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/cdc/owner/NewChangefeedRetryError=return(true)'
	kill $capture_pid
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/cdc/owner/InjectChangefeedDDLError=return(true)'
	run_cdc_server --workdir $WORK_DIR --binary $CDC_BINARY
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/pkg/txnutil/gc/InjectActualGCSafePoint=return(9223372036854775807)'
	run_cdc_server --workdir $WORK_DIR --binary $CDC_BINARY

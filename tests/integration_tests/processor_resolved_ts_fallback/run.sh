...
function run() {
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/cdc/sink/SinkFlushDMLPanic=return(true);github.com/amyangfei/tiflow/cdc/sink/producer/kafka/SinkFlushDMLPanic=return(true)'

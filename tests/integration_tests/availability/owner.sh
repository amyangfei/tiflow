...
function test_owner_retryable_error() {
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/cdc/capture/capture-campaign-compacted-error=1*return(true)'
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/cdc/owner/owner-run-with-error=1*return(true);github.com/amyangfei/tiflow/cdc/capture/capture-resign-failed=1*return(true)'
...
function test_gap_between_watch_capture() {
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/cdc/owner/sleep-in-owner-tick=1*sleep(6000)'

...
function run() {
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/cdc/sink/MySQLSinkExecDDLDelay=return(true);github.com/amyangfei/tiflow/cdc/capture/ownerFlushIntervalInject=return(10)'

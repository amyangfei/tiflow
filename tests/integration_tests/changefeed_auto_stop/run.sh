...
function run() {
	...
	export GO_FAILPOINTS='github.com/amyangfei/tiflow/cdc/processor/pipeline/ProcessorSyncResolvedError=1*return(true);github.com/amyangfei/tiflow/cdc/processor/ProcessorUpdatePositionDelaying=sleep(1000)'

...
import (
	...
	"github.com/amyangfei/tiflow/tests/mq_protocol_tests/cases"
	"github.com/amyangfei/tiflow/tests/mq_protocol_tests/framework"
	"github.com/amyangfei/tiflow/tests/mq_protocol_tests/framework/avro"
	"github.com/amyangfei/tiflow/tests/mq_protocol_tests/framework/canal"
	"github.com/amyangfei/tiflow/tests/mq_protocol_tests/framework/mysql"
	"go.uber.org/zap"
...
func testMySQLWithCheckingOldValue() {
	env := mysql.NewDockerEnv(*dockerComposeFile)
	env.DockerComposeOperator.ExecEnv = []string{"GO_FAILPOINTS=github.com/amyangfei/tiflow/cdc/sink/SimpleMySQLSinkTester=return(ture)"}

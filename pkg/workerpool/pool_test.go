...
func TestCancelHandle(t *testing.T) {
	...
	err := failpoint.Enable("github.com/amyangfei/tiflow/pkg/workerpool/addEventDelayPoint", "1*sleep(500)")
	require.Nil(t, err)
	defer func() {
		_ = failpoint.Disable("github.com/amyangfei/tiflow/pkg/workerpool/addEventDelayPoint")
	}()
...
func TestCancelTimer(t *testing.T) {
	...
	err := failpoint.Enable("github.com/amyangfei/tiflow/pkg/workerpool/unregisterDelayPoint", "sleep(5000)")
	require.Nil(t, err)
	defer func() {
		_ = failpoint.Disable("github.com/amyangfei/tiflow/pkg/workerpool/unregisterDelayPoint")
	}()
...
// go test -benchmem -run='^$' -bench '^(BenchmarkWorkerpool)$' github.com/amyangfei/tiflow/pkg/workerpool

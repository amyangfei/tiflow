...
var changefeedStateFromAdminJobVersions = []semver.Version{
	// Introduced in https://github.com/amyangfei/tiflow/pull/3014.
	*semver.New("4.0.16"),
	// Introduced in https://github.com/amyangfei/tiflow/pull/2946.
	*semver.New("5.0.6"),
}
...
func (f *CreatorVersionGate) ChangefeedStateFromAdminJob() bool {
	// Introduced in https://github.com/amyangfei/tiflow/pull/1341.

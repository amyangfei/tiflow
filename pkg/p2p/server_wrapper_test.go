...
func TestServerWrapperDelayed(t *testing.T) {
	...
	err := failpoint.Enable("github.com/amyangfei/tiflow/pkg/p2p/ServerWrapperSendMessageDelay", "pause")
	require.NoError(t, err)
	defer func() {
		_ = failpoint.Disable("github.com/amyangfei/tiflow/pkg/p2p/ServerWrapperSendMessageDelay")
	}()

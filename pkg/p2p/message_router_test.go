...
func TestMessageRouterClientFailure(t *testing.T) {
	...
	err := failpoint.Enable("github.com/amyangfei/tiflow/pkg/p2p/InjectClientPermanentFailure", "return(true)")
	require.NoError(t, err)
	defer func() {
		_ = failpoint.Disable("github.com/amyangfei/tiflow/pkg/p2p/InjectClientPermanentFailure")
	}()

...
func TestMessageClientServerRestart(t *testing.T) {
	_ = failpoint.Enable("github.com/amyangfei/tiflow/pkg/p2p/ServerInjectServerRestart", "1%return(true)")
	defer func() {
		_ = failpoint.Disable("github.com/amyangfei/tiflow/pkg/p2p/ServerInjectServerRestart")
	}()
...
func TestMessageClientRestart(t *testing.T) {
	_ = failpoint.Enable("github.com/amyangfei/tiflow/pkg/p2p/ClientInjectStreamFailure", "50%return(true)")
	defer func() {
		_ = failpoint.Disable("github.com/amyangfei/tiflow/pkg/p2p/ClientInjectStreamFailure")
	}()
...
func TestMessageClientRestartMultiTopics(t *testing.T) {
	_ = failpoint.Enable("github.com/amyangfei/tiflow/pkg/p2p/ClientInjectStreamFailure", "3%return(true)")
	defer func() {
		_ = failpoint.Disable("github.com/amyangfei/tiflow/pkg/p2p/ClientInjectStreamFailure")
	}()
...
func TestMessageClientSenderErrorsMultiTopics(t *testing.T) {
	_ = failpoint.Enable("github.com/amyangfei/tiflow/pkg/p2p/ClientBatchSenderInjectError", "3*return(true)")
	defer func() {
		_ = failpoint.Disable("github.com/amyangfei/tiflow/pkg/p2p/ClientBatchSenderInjectError")
	}()
...
func TestMessageBackPressure(t *testing.T) {
	...
	_ = failpoint.Enable("github.com/amyangfei/tiflow/pkg/p2p/ServerInjectTaskDelay", "sleep(1)")
	defer func() {
		_ = failpoint.Disable("github.com/amyangfei/tiflow/pkg/p2p/ServerInjectTaskDelay")
	}()

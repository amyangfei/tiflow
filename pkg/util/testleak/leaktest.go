...
func interestingGoroutines() (gs []string) {
	...
	ignoreList := []string{
		...
		"github.com/amyangfei/tiflow/cdc/sorter/unified.newBackEndPool",
		"github.com/amyangfei/tiflow/cdc/sorter/unified.(*heapSorter).flush",
		// kv client region worker pool
		"github.com/amyangfei/tiflow/cdc/kv.RunWorkerPool",
		"github.com/amyangfei/tiflow/pkg/workerpool.(*defaultPoolImpl).Run",
		// library used by log

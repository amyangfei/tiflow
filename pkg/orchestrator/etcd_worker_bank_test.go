...
func (s *etcdWorkerSuite) TestEtcdBank(c *check.C) {
	...
	_ = failpoint.Enable("github.com/amyangfei/tiflow/pkg/orchestrator/InjectProgressRequestAfterCommit", "10%return(true)")
	defer func() {
		_ = failpoint.Disable("github.com/amyangfei/tiflow/pkg/orchestrator/InjectProgressRequestAfterCommit")
	}()

...
// Run the benchmark
// go test -benchmem -run='^$' -bench '^(BenchmarkActorSendReceive)$' github.com/amyangfei/tiflow/pkg/actor
...
// Run the benchmark
// go test -benchmem -run='^$' -bench '^(BenchmarkPollActor)$' github.com/amyangfei/tiflow/pkg/actor
